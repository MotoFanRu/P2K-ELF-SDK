...
// обновить событие
DBK_RESULT_T
DL_DBK_UpdateEventData(IFACE_DATA_T *iface_data, DBK_EVENT_INSTANCE_T *event_instance);
...
DBK_RESULT_T
DL_DBK_TestForEventOverlap(IFACE_DATA_T *iface_data, DBK_EVENT_INSTANCE_T *event_instance);

DBK_RESULT_T
DL_DBK_GetNumberOfEventsOnDate(IFACE_DATA_T *iface_data, CLK_DATE_T date);
...
DBK_RESULT_T
DL_DBK_GetNextEventInTimeFrame(
	IFACE_DATA_T *iface_data,
...
DBK_RESULT_T
DL_DBK_GetPreviousEventInTimeFrame(
	IFACE_DATA_T *iface_data,
	UINT32 event_id,
...
DBK_RESULT_T
DL_DBK_GetEventInstanceByIdNumber(IFACE_DATA_T *iface_data, UINT32 event_id);

DBK_RESULT_T DL_DBK_GetMonthView(IFACE_DATA_T *iface_data, CLK_DATE_T start_date, CLK_DATE_T end_date);

DBK_RESULT_T DL_DBK_GetWeekView(IFACE_DATA_T *iface_data, CLK_DATE_T start_date, CLK_DATE_T end_date);

DBK_RESULT_T
DL_DBK_GetNextEventForDayView(IFACE_DATA_T *iface_data, BOOL first_event, CLK_DATE_T day_to_view);

DBK_RESULT_T
DL_DBK_GetNextAlarm(IFACE_DATA_T *iface_data, DBK_SORT_T *prev_alarm_info_ptr);
