...
WS_RESULT_T
DL_DbWebSessionsGetSessionByIndex(IFACE_DATA_T *iface_data, UINT8 index, WS_RECORD_T *ws_record);
...
// удалить запись
WS_RESULT_T
DL_DbWebSessionsDeleteSessionByIndex(IFACE_DATA_T *iface_data, UINT8 index,
                                     UINT8 unk);  // = 0

// кол-во  возможных записей
WS_RESULT_T
DL_DbWebSessionsGetNumberGoodSessions(
	UINT8 device_type,  // =0
	UINT8 *total_num,
	UINT8 unk
);  // = 0
...
WS_RESULT_T
DL_DbWebSessionsGetNumberUsedSessions(
	UINT8 device_type,  // =0
	UINT8 *used_num,
	UINT8 unk
);  // = 0
...
WS_RESULT_T
DL_DbWebSessionsGetNumberAvailableSessions(
	UINT8 device_type,  // =0
	UINT8 *available_num,
	UINT8 unk
);  // = 0
