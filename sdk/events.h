...
UINT32
AFW_AddEvAux(EVENT_STACK_T *ev_st, UINT32 event_code, FREE_BUF_FLAG_T free_buf, UINT32 att_size, void *attachment);
...
UINT32 APP_UtilAddEvUISGetDataForItem(EVENT_STACK_T *ev_st, void *app, UINT32 index);
