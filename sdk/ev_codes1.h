...
#elif defined(FTR_V635)
#define EV_USER_ACTIVITY_TIMEOUT 0x0776
#define EV_SCREENSAVER_TIMEOUT   0x0778
#define EV_DISPLAY_TIMEOUT       0x0779
#define EV_BACKLIGHT_TIMEOUT     0x077A
#define EV_INACTIVITY_TIMEOUT    0x077B
#else
