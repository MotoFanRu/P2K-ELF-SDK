...
UINT32 AhiSurfInfo(AHIDEVCONTEXT_T devCx, AHISURFACE_T surf, AHISURFINFO_T *info);
...
UINT32 AhiDispSurfSet(AHIDEVCONTEXT_T devCx, AHISURFACE_T surf, UINT32 flags);
...
UINT32 AhiDrawBrushSet(AHIDEVCONTEXT_T devCx, AHIBITMAP_T *pattern, AHIPOINT_T *srcPt, UINT32 param3, UINT32 flags);
#define AHIFLAG_BRUSH_TRANSPARENT 1
#define AHIFLAG_BRUSH_SOLID       2

/* Устанавливает текущую поверхность-источник (source)  */
UINT32 AhiDrawSurfSrcSet(AHIDEVCONTEXT_T devCx, AHISURFACE_T surf, UINT32 flags);

/* Устанавливает текущую поверхность-приёмник (destination)  */
UINT32 AhiDrawSurfDstSet(AHIDEVCONTEXT_T devCx, AHISURFACE_T surf, UINT32 flags);
...
UINT32 AhiDrawAlphaSet(AHIDEVCONTEXT_T devCx, UINT32 alpha);
...
UINT32 AhiDrawLines(AHIDEVCONTEXT_T devCx, AHIPOINT_T *pointArr, UINT32 count, UINT32 flags);
#define AHIFLAG_LINE_STRIP    0
#define AHIFLAG_LINE_SEPARATE 1

/* Рисует набор прямоугольных областей */
UINT32 AhiDrawSpans(AHIDEVCONTEXT_T devCx, AHIRECT_T *rectArr, UINT32 count, UINT32 flags);
...
UINT32 AhiDrawBitBltMulti(AHIDEVCONTEXT_T devCx, AHIRECT_T *dstRectArr, AHIPOINT_T *srcPtArr, UINT32 count);
...
UINT32 AhiDrawStretchBlt(AHIDEVCONTEXT_T devCx, AHIRECT_T *dstRect, AHIRECT_T *srcRect, UINT32 flags);
...
UINT32 AhiDrawBlendBlt(AHIDEVCONTEXT_T devCx, AHIRECT_T *dstRect, AHIPOINT_T *srcPt, AHIBLEND_T blendOp, UINT32 flags);
...
UINT32 AhiDrawChar(AHIDEVCONTEXT_T devCx, AHIPOINT_T *dstPt, AHICHAR_T *charsArr, UINT32 count, UINT32 flags);

/* Рисует набор символов, аналогично AhiDrawChar */
UINT32 AhiDrawGlyph(AHIDEVCONTEXT_T devCx, AHIPOINT_T *dstPt, AHIBITMAP_T *charsArr, UINT32 count, UINT32 flags);
