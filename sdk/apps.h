...
UINT32 APP_Exit(EVENT_STACK_T *ev_st, APPLICATION_T *app,
                UINT32 param2);  // = 0
...
UINT32 APP_UtilHistSaveAndChangeState(
	void *data,
	EVENT_STACK_T *ev_st,
	APPLICATION_T *app,
	UINT8 new_state
...
UINT32 AFW_AddAppToRoutingStack(
	void *hefn,
	UINT8 fntype,
