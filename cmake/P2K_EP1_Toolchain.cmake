...
if(CMAKE_HOST_WIN32)
	set(TOOLCHAIN_DIRECTORY "tool/ep1_win_ADS12_848/Bin")
elseif(CMAKE_HOST_UNIX)
	set(TOOLCHAIN_DIRECTORY "tool/ep1_lin_ADS12_848/bin")
else()
	message(FATAL_ERROR "Unknown OS!")
endif()

if(CPU_MODE STREQUAL "thumb")
	set(CMAKE_C_COMPILER "${P2K_TOOLCHAIN_ROOT}/${TOOLCHAIN_DIRECTORY}/tcc")
	set(CMAKE_CXX_COMPILER "${P2K_TOOLCHAIN_ROOT}/${TOOLCHAIN_DIRECTORY}/tcpp")
elseif(CPU_MODE STREQUAL "arm")
	set(CMAKE_C_COMPILER "${P2K_TOOLCHAIN_ROOT}/${TOOLCHAIN_DIRECTORY}/armcc")
	set(CMAKE_CXX_COMPILER "${P2K_TOOLCHAIN_ROOT}/${TOOLCHAIN_DIRECTORY}/armcpp")
else()
	message(FATAL_ERROR "Please set '$CPU_MODE' to 'thumb' or 'arm'!")
endif()
set(CMAKE_ASM_COMPILER "${P2K_TOOLCHAIN_ROOT}/${TOOLCHAIN_DIRECTORY}/armasm")
set(CMAKE_AR "${P2K_TOOLCHAIN_ROOT}/${TOOLCHAIN_DIRECTORY}/armar")
set(CMAKE_C_LINK_EXECUTABLE "${P2K_TOOLCHAIN_ROOT}/${TOOLCHAIN_DIRECTORY}/armlink")
set(CMAKE_CXX_LINK_EXECUTABLE "${P2K_TOOLCHAIN_ROOT}/${TOOLCHAIN_DIRECTORY}/armlink")
if(CMAKE_HOST_WIN32)
