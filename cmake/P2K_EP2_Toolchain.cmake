...
if(CMAKE_HOST_WIN32)
	set(TOOLCHAIN_DIRECTORY "${P2K_TOOLCHAIN_ROOT}/tool/compiler/ep2_win_devkitARM/bin")
elseif(CMAKE_HOST_UNIX)
	set(TOOLCHAIN_DIRECTORY "${P2K_TOOLCHAIN_ROOT}/tool/compiler/ep2_lin_devkitARM/bin")
else()
	message(FATAL_ERROR "Unknown OS for CMake!")
endif()

set(CMAKE_C_COMPILER "${TOOLCHAIN_DIRECTORY}/arm-eabi-gcc")
set(CMAKE_CXX_COMPILER "${TOOLCHAIN_DIRECTORY}/arm-eabi-g++")
#set(CMAKE_ASM_COMPILER "${TOOLCHAIN_DIRECTORY}/arm-eabi-as")
set(CMAKE_ASM_COMPILER "${TOOLCHAIN_DIRECTORY}/arm-eabi-gcc")
set(CMAKE_AR "${TOOLCHAIN_DIRECTORY}/arm-eabi-ar")
set(CMAKE_C_LINK_EXECUTABLE "${TOOLCHAIN_DIRECTORY}/arm-eabi-ld")
set(CMAKE_CXX_LINK_EXECUTABLE "${TOOLCHAIN_DIRECTORY}/arm-eabi-ld")
set(CMAKE_OBJCOPY "${TOOLCHAIN_DIRECTORY}/arm-eabi-objcopy")
