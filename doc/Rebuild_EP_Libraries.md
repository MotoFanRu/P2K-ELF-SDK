...
1. Get `release/gsm_flash_dev.sym` symbols file from building system and copy it to `prepared` directory.
...
./ep1_portkit.py -P E1_R373_G_0E.30.DAR_test17_v80 -B -t -a -p ../../ep1/pts/E1_R373_G_0E.30.DAR.pts
cp build/Library.sym prepared/portkit.sym

# Get from `gsm_flash_dev.sym` only the necessary entities.
./forge.py -sn -s prepared/gsm_flash_dev.sym -d ../../res/E1_R373_G_0E.30.DAR_test17/elfloader.sym -e EP1 -pf 'E1_R373_G_0E.30.DAR' -o prepared/ep1_gsm.sym
./forge.py -sn -s prepared/gsm_flash_dev.sym -d ../../res/E1_R373_G_0E.30.DAR_test17/library.sym -e EP2 -pf 'E1_R373_G_0E.30.DAR' -o prepared/ep2_gsm.sym

# Found all missing symbols and constants then save it.
./compare.py -s prepared/ep1_gsm.sym -c ../../res/E1_R373_G_0E.30.DAR_test17/elfloader.sym -n
./compare.py -s prepared/ep1_gsm.sym -c ../../res/E1_R373_G_0E.30.DAR_test17/elfloader.sym -n &> prepared/ep1_notfound.log
./compare.py -s prepared/ep2_gsm.sym -c ../../res/E1_R373_G_0E.30.DAR_test17/library.sym -ec EP2 -n
./compare.py -s prepared/ep2_gsm.sym -c ../../res/E1_R373_G_0E.30.DAR_test17/library.sym -ec EP2 -n &> prepared/ep2_notfound.log
...
cat prepared/ep2_notfound.log | grep 0x | grep ' C ' | awk '{print $4 " " $5 " " $6;}' | tr -d '"' > prepared/ep2_const.def
...
./forge.py -sn -c -s ../../res/E1_R373_G_0E.30.DAR_test17/library.sym -d prepared/ep2_const.def -e EP2 -pf 'E1_R373_G_0E.30.DAR' -o prepared/ep2_const.sym
...
./compare.py -s prepared/ep1_combined.sym -c ../../res/E1_R373_G_0E.30.DAR_test17/elfloader.sym -n
./compare.py -s prepared/ep2_combined.sym -c ../../res/E1_R373_G_0E.30.DAR_test17/library.sym -ec EP2 -n
```
...
4. Fix `SBCM_ATOD_temp` and `SBCM_ATOD_vltg` addresses and modes in `library.sym` listing, Use `-1` operation on address.
...
4. Generate final EP1/EP2 libraries and clean listings.
